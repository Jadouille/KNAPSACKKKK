 ...
 */
public class lParcel {
    private int value;
    private int type;
    private ArrayList<lParcel> rotations = new ArrayList<>();
    ...
    public lParcel(int value, int type){
        this.value = value;
        this.type = type;
        ...
        Coordinate coord4 = (new Coordinate(0, 3, 0)); coords.add(coord4);
        Coordinate coord5 = (new Coordinate(1, 0, 0)); coords.add(coord5);
    ...
    public void setCornerCoords(Coordinate initialCoord, int cubeUnit){
        ...
        this.cornerCoords.add(2, new Coordinate(initialCoord.getX() + (4 * cubeUnit), initialCoord.getY(), initialCoord.getZ() + (2 * cubeUnit)));
        this.cornerCoords.add(3, new Coordinate(initialCoord.getX() + (4 * cubeUnit), initialCoord.getY(), initialCoord.getZ() + cubeUnit));
        this.cornerCoords.add(4, new Coordinate(initialCoord.getX() + cubeUnit, initialCoord.getY(), initialCoord.getZ() + cubeUnit));
        this.cornerCoords.add(5, new Coordinate(initialCoord.getX() + cubeUnit, initialCoord.getY(), initialCoord.getZ()));
        ...
        this.cornerCoords.add(8, new Coordinate(initialCoord.getX() + (4 * cubeUnit), initialCoord.getY() + cubeUnit, initialCoord.getZ() + (2* cubeUnit)));
        this.cornerCoords.add(9, new Coordinate(initialCoord.getX() + (4 * cubeUnit), initialCoord.getY() + cubeUnit, initialCoord.getZ() + cubeUnit));
        this.cornerCoords.add(10, new Coordinate(initialCoord.getX() + cubeUnit, initialCoord.getY() + cubeUnit, initialCoord.getZ() + cubeUnit));
        this.cornerCoords.add(11, new Coordinate(initialCoord.getX() + cubeUnit, initialCoord.getY() + cubeUnit, initialCoord.getZ()));
    }
    ...
    public ArrayList<lParcel> getRotations() {
        return rotations;
    }
    ...
    public int compareTo(Object compareToParcel){
        ...
        double densityFirst = (double) ((lParcel) compareToParcel).getValue();
        double densitySecond = (double) ((lParcel)this).getValue();
    ...
    public lParcel clone(){
        lParcel rParcel = new lParcel(this.value, this.type);
